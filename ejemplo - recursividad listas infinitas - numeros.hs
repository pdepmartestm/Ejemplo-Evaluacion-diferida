...
factorial 0 = 1
factorial n | n <0 = error " los negativos no tienen factorial"
...
funcionLoca1 x = x : funcionLoca1 (x+1)
funcionLoca2 x = x : funcionLoca2 (x*2)

funcionLoca x = x : funcionLoca x


tomarTantos x =  take x (funcionLoca2 1) 
